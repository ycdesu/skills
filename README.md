...
> **Prerequisite:** If you use [Obsidian](https://obsidian.md/), install or enable the [Obsidian CLI](https://github.com/Vinzent03/obsidian-cli) so wiki files can be opened directly from the terminal.
